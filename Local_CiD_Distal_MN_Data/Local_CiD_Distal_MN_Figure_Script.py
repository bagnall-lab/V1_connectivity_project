...
VLMN_1 = np.load('VLMN_run1_local_CiA_CiD_distal_CiA_MN.npy')                                                                                                                          
VLMN_2 = np.load('VLMN_run2_local_CiA_CiD_distal_CiA_MN.npy')                                                                                                                        
VLMN_3 = np.load('VLMN_run3_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_4 = np.load('VLMN_run4_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_5 = np.load('VLMN_run5_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_6 = np.load('VLMN_run6_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_7 = np.load('VLMN_run7_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_8 = np.load('VLMN_run8_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_9 = np.load('VLMN_run9_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_10 = np.load('VLMN_run10_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_11 = np.load('VLMN_run11_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_12 = np.load('VLMN_run12_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_13 = np.load('VLMN_run13_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_14 = np.load('VLMN_run14_local_CiA_CiD_distal_CiA_MN.npy')
VLMN_15 = np.load('VLMN_run15_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_1 = np.load('VLIC_run1_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_1 = np.load('VLCiD_run1_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_1 = np.load('VLCiA_run1_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_2 = np.load('VLIC_run2_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_2 = np.load('VLCiD_run2_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_2 = np.load('VLCiA_run2_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_3 = np.load('VLIC_run3_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_3 = np.load('VLCiD_run3_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_3 = np.load('VLCiA_run3_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_4 = np.load('VLIC_run4_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_4 = np.load('VLCiD_run4_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_4 = np.load('VLCiA_run4_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_5 = np.load('VLIC_run5_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_5 = np.load('VLCiD_run5_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_5 = np.load('VLCiA_run5_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_6 = np.load('VLIC_run6_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_6 = np.load('VLCiD_run6_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_6 = np.load('VLCiA_run6_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_7 = np.load('VLIC_run7_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_7 = np.load('VLCiD_run7_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_7 = np.load('VLCiA_run7_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_8 = np.load('VLIC_run8_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_8 = np.load('VLCiD_run8_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_8 = np.load('VLCiA_run8_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_9 = np.load('VLIC_run9_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_9 = np.load('VLCiD_run9_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_9 = np.load('VLCiA_run9_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_10 = np.load('VLIC_run10_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_10 = np.load('VLCiD_run10_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_10 = np.load('VLCiA_run10_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_11 = np.load('VLIC_run11_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_11 = np.load('VLCiD_run11_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_11 = np.load('VLCiA_run11_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_12 = np.load('VLIC_run12_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_12 = np.load('VLCiD_run12_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_12 = np.load('VLCiA_run12_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_13 = np.load('VLIC_run13_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_13 = np.load('VLCiD_run13_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_13 = np.load('VLCiA_run13_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_14 = np.load('VLIC_run14_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_14 = np.load('VLCiD_run14_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_14 = np.load('VLCiA_run14_local_CiA_CiD_distal_CiA_MN.npy')

VLIC_15 = np.load('VLIC_run15_local_CiA_CiD_distal_CiA_MN.npy') 
VLCiD_15 = np.load('VLCiD_run15_local_CiA_CiD_distal_CiA_MN.npy')
VLCiA_15 = np.load('VLCiA_run15_local_CiA_CiD_distal_CiA_MN.npy')

Time = np.load('Time_run1_local_CiA_CiD_distal_CiA_MN.npy')


Connectome_Weights = np.load('CW_run1_local_CiA_CiD_distal_CiA_MN.npy',allow_pickle=True)
...
def ChemicalSynapseWeightMatrix(Connectome_Weights,Title):
    ...
    #plt.imshow(stackf,cmap=plt.cm.BuPu_r,norm=clr.SymLogNorm(linthresh=0.0001,vmin=0, vmax=0.5))
    #plt.colorbar()
    plt.show()
...
Title = 'Tonic Drive Distal CiA_CiD Local CiA_MN 3 Runs'
